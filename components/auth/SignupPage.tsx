  ...
  return (
    <>
      <div className="auth-page">
        {/* Split background — left dark navy, right light grey */}
        ...
        <div className="auth-shell">
          <div className="auth-card">
            ...
            {/* ── LEFT — Image panel (inset rounded card) ── */}
              ...
              <div className="auth-form-inner">
                ...
                <div className="auth-center-block">
                  ...
                  <div className="auth-form-box">
                    ...
                    <button type="button" className="auth-cta-btn">
      ...
      <style jsx>{`
        * { box-sizing: border-box; }
        ...
        .auth-visual-top-right {
          display: flex;
          align-items: center;
          gap: 12px;
          flex-shrink: 0;
        }
        .auth-visual-top-right span {
          font-size: 0.84rem;
          color: rgba(255,255,255,0.85);
          white-space: nowrap;
        }
        ...
        .auth-visual-top-right button:hover {
        ...
        .auth-google-btn:hover { border-color: #0d1b3e; }
